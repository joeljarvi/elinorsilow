...
export default function ExhibitionModal({
  ...
  return (
    <AnimatePresence>
      <motion.div
        key="overlay"
        className="fixed inset-0 z-20   grid grid-cols-4 min-h-screen scrollbar-hide overflow-hidden   "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      >
        ...
        <motion.div
          ...
          className="relative col-start-1 lg:col-start-2 col-span-3  lg:col-span-3  h-full  overflow-auto flex flex-col scrollbar-hide "
