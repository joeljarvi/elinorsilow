...
export function HeroText() {
  ...
  return (
    <motion.p
      ...
      ref={containerRef}
      className=" text-[16px] lg:text-[19px] leading-[1.2] mx-0 px-[0px] no-hide-text font-timesNewRoman text-foreground  tracking-wide pt-[18px] pb-[18px] pointer-events-none mb-[0px] max-w-3xl   "
    >
